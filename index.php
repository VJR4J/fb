...
<div class="div1" style="position:absolute; left:5%; top:37%>
    ...
    <div style="position:absolute; left:5%; top:23%; color:#3B5998; font-size:25px;"> <font face="myFbFont"> Friendsbook helps you connect and share with </font> </div>
    <div style="position:absolute; left:5%; top:29%; color:#3B5998; font-size:25px;"> <font face="myFbFont"> the people in your life. </font></div>



	<!-- Registration -->
	<form  method="post" onSubmit="return check();" name="Reg">
		<div style="position:absolute;left:58%; top:14.5%; color:#3B5998; font-size:25"> <h5> Sign Up </h5> </div>
...
<div style="position:absolute;left:60.28%; top:74.8%; font-size:16px; color:#000000">  Birthday:  </div>
 ...
 <!--my_details -->  
    ...
    <div style="position:absolute;left:26%;top:75%; z-index:3; color:#FFF;"> <h3> <?php echo base64_decode("VklKQVlSQUogUyBIT05OVVI="); ?> </h3> </div>
    <div style="position:absolute;left:26%;top:83%; z-index:3; color:#FFF;">  <h3><?php echo base64_decode("aC52aWpheXJhakBnbWFpbC5jb20="); ?> </h3> </div>
    <div style="position:absolute;left:26%;top:90%; z-index:3; color:#FFF;"> <h3> <?php echo base64_decode("ODk1MTQxNDk5MA=="); ?>  </h3> </div>
	</div>
