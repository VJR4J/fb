...
<body>
    ...
    <div style="position:absolute;left:5%;top:105%;"><font face="myFbFont"> Developed By : <span style=" color:#3B5998;" onMouseOver="open_developer_details()" onMouseOut="close_developer_details()" id="my_name">  VIJAYRAJ & PRASHANTH </span> </font> </div>
