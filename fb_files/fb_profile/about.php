...
<div style="position:absolute;left:53%; top:175%; font-size:18px; color:#89919C;">Friendsbook ID </div>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:61%;top:175%; color:#3B59A4; font-weight:bold;">&nbsp&nbsp Add Friendsbook ID </div>
<?php
	}
?> 
...
<div style="position:absolute;left:53%;top:156%; font-size:18px; color:#89919C;"> Mobile Phone </div>
